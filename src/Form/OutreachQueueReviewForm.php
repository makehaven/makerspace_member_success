...
class OutreachQueueReviewForm extends FormBase {
  ...
  public function __construct(
    ...
    protected OutreachCandidateGenerator $candidateGenerator,
  ) {}
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      ...
      $container->get('makerspace_member_success.outreach_candidate_generator')
    );
  }
  ...
  public function submitGenerateCandidates(array &$form, FormStateInterface $form_state): void {
    $generated = 0;
    foreach ($this->candidateGenerator->generate() as $candidate) {
